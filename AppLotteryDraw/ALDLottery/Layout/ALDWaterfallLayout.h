...
@class ALDWaterfallLayout;

@protocol ALDWaterfallLayoutDelegate<NSObject>
...
@interface ALDWaterfallLayout : UICollectionViewLayout
...
//代理，用来计算item的高度
@property (nonatomic, weak) id<ALDWaterfallLayoutDelegate> delegate;
